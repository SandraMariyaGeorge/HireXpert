...
// const Form = () => {
//   return (
//     <section id="form" className="py-20 px-4 sm:px-6 lg:px-8 bg-black dark:bg-black">
...
//           </Badge>
//           <TypewriterEffect text="HiireExpert your interviewing spree in" /> 
    ...
    <main className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-gray-800 text-white">
      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto">
          <span className="px-4 py-1.5 mb-6 text-sm font-semibold bg-white text-white rounded-full inline-block">
            AI-Powered Interviews
          </span>
          <h1 className="text-4xl sm:text-5xl font-bold text-transparent bg-gradient-to-r from-white via-white-500 to-indigo-600 bg-clip-text mb-6">
            HireExpert: Supercharge Your Hiring Process in 50+ Languages
          </h1>
